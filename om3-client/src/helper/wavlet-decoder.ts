...
export { constructMinMaxMissTrendTree, initWaveletDecode, waveletDecode, constructTrendTree, constructHaarTree, constructMinMaxMissTrendTreeMulti, constructMinMaxMissTrendTreeForGetChildTree }